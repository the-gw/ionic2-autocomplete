...
import { Observable, Subject, noop, from } from 'rxjs';
...
export class AutoCompleteComponent implements ControlValueAccessor {
  ...
  @ViewChild('searchbarElem', { read: ElementRef }) searchbarElem: ElementRef<IonSearchbar>;
  ...
  private getFormValue(selection: any): any {
    ...
    let attr =
      this.dataProvider.formValueAttribute == null
